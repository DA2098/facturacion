...
async function main() {
  ...
  if (args.length === 0) {
    console.error('Usage: node scripts/run-sql.js <file1.sql> [file2.sql ...] [CONNECTION_STRING]');
    process.exit(1);
  }

  // If last arg looks like a connection string (starts with postgres), use it
